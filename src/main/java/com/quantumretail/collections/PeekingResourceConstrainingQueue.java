 ...
 * <p>
 * Concurrency note:
 * There are several important concurrency-related issues to keep in mind when using this subclass of ResourceConstrainingQueue:
 * <p>
 ...
 * <p>
 * If strict == false in the constructor, we will *not* lock -- <strong>even on reads</strong>. That means that two concurrent reads can return
